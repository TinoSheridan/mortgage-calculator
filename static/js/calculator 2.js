...
function updateMaxSellerContributionDisplay(result) {
    try {
        ...
        if (result && result.loan_details && result.loan_details.max_seller_contribution !== undefined) {
            const maxContribution = result.loan_details.max_seller_contribution;
            ...
            if (result.loan_details.seller_credit_exceeds_max === true) {
            ...
            maxContributionElement.textContent = 'Max contribution will be displayed when you calculate results';
            maxContributionElement.classList.remove('text-danger');
            maxContributionElement.classList.add('text-info');
        }
    } catch (e) {
        console.error('Error updating max seller contribution display:', e);
    }
}
