...
def test_va_funding_fee():
    ...
    for case in test_cases:
        ...
        print(f"Params: service={case['service_type']}, usage={case['loan_usage']}, down={case['down_payment_percentage']}%")
        ...
        if abs(funding_fee - expected_fee) < 0.01:
            ...
            print(f"❌ FAIL: Funding fee does not match. Difference: ${abs(funding_fee - expected_fee):,.2f}")
